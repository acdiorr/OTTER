...
std::string windowTitle = "Ricardo Prato 100787893";
...
bool initGLFW() {
	...
	if (glfwInit() == GLFW_FALSE) {
		...
		// Set our window resized callback glfwSetWindowSizeCallback(window, GlfwWindowResizedCallback);
		return false;
	}
...
int main() {
	...
	static const float interleaved[] = {
		//X      Y     Z     R     G    B
		 0.9f, -0.5f, 0.5f, 0.0f, 0.0f, 0.0f,
		 0.9f, 0.5f, 0.5f, 0.3f, 0.2f, 0.5f,
		 0.3f, 0.5f, 0.5f, 1.0f, 1.0f, 0.0f,
		 0.1f, -0.5f, 0.5f, 1.0f, 1.0f, 1.0f
	};
